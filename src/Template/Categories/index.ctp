      ...
      <?php foreach ($categories as $category) : ?>
        ...
        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
          <?php echo $this->Html->image("ocean-1.jpg", [
					...
					<?php echo $this->Html->link('Edit', ['action' => 'edit', $category->id], ['class' => 'btn btn-sm btn-primary']) ?>
        </div>
				</div>
			<?php endforeach; ?>
    </div>
...
<div class="container">
  <div class="row">
	  <div class="col-12" style="padding: 40px 0;">
		  <h5>Admin Area</h5>
		  <?php echo $this->Html->link('Add new Category', ['action' => 'add'], ['class' => 'btn btn-primary']); ?>
	  </div>
	</div>
</div>	
